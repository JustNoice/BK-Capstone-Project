...
import 'package:bk_lapor_book_main/components/vars.dart';
...
class AddFormState extends State<AddFormPage> {
  ...
  void addTransaksi(Akun akun) async {
    ...
    try {
      ...
      // Inisialisasi likeCount dengan nilai 0
      int likeCount = 0;
      ...
      await laporanCollection.doc(id).set({
        ...
        'tanggal': timestamp,
        'maps': maps,
        'likeCount': likeCount, // Tambahkan inisialisasi likeCount di sini
      }).catchError((e) {
        throw e;
      });
